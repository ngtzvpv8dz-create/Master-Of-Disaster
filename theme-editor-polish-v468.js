...
(function(){
  ...
  function injectStyle(){
    ...
    const st=document.createElement('style');st.id='themeEditorPolishV468Style';st.textContent=`
      ...
      .theme-info-v468{display:inline-flex;align-items:center;justify-content:center;width:18px;height:18px;margin-left:6px;margin-right:auto;padding:0;border:1px solid var(--mod-border,#30363b);border-radius:50%;background:var(--mod-control,#101315);color:var(--mod-text,#f3f3f3);font-size:10px;font-weight:950;line-height:1;vertical-align:middle;cursor:pointer}
      ...
      .theme-mini-v468.hit,.theme-mini-v468 [data-v468-zone].hit{outline:2px solid #ffd166!important;outline-offset:2px;box-shadow:0 0 0 4px rgba(255,209,102,.18)!important}
