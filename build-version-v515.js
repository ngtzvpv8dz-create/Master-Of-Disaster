/* V515 · CURRENT BUILD MARKER */
(function(){
  'use strict';
  if(window.__modBuildVersionV515)return;
  const meta={version:'V515',date:'09.09.2026',time:'09:38',build:'09.09.2026 · 09:38 Uhr'};
  function patch(){
  ...
  if(typeof previous==='function'&&!previous.__modBuildV515){
    const wrapped=function(){const out=previous.apply(this,arguments);setTimeout(patch,0);return out;};
    wrapped.__modBuildV515=true;
    window.render=wrapped;
  }
  window.__modBuildVersionV515={...meta,patch};
  window.addEventListener('load',()=>setTimeout(patch,650));
  setTimeout(patch,0);
})();
