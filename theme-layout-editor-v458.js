...
(function(){
  ...
  function injectRuntimeStyle(){
    ...
    style=document.createElement('style');style.id='themeLayoutV458RuntimeStyle';style.textContent=`
      ...
      body .task .icon-action,body .task .repeat-button{width:var(--mod-card-action-size)!important;height:var(--mod-card-action-size)!important;flex-basis:var(--mod-card-action-size)!important;font-size:var(--mod-actions-size)!important;font-weight:var(--mod-actions-weight)!important;line-height:var(--mod-actions-line)!important;color:var(--mod-actions-color)!important;background:var(--mod-control)!important;border-color:var(--mod-border)!important}
