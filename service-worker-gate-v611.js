...
(function(){
  ...
  function emit(extra={}){
    status={...status,...extra};
    try{
      window.dispatchEvent(new CustomEvent('mod:worker-gate-v611-status',{detail:{...status,version:VERSION}}));
  ...
  const ready=(async()=>{
    ...
    try{
      ...
      console.error('V611 Worker Gate:',error);
  ...
  window.__modWorkerGateV611=api;
  /* Kompatibilitätsalias für Runtime-Code, der noch den alten globalen Namen liest. */
  window.__modWorkerGateV607=api;
})();