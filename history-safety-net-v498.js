...
(function(){
  ...
  function installBackupOverride(){const btn=document.getElementById('fullBackupV397');if(!btn||btn.dataset.v498Enhanced==='1')return;btn.dataset.v498Enhanced='1';btn.textContent='📦 VOLLSTÄNDIGES KOMPLETT-BACKUP';btn.onclick=createEnhancedFullBackup;const wrap=document.getElementById('fullBackupWrapV397');const note=wrap?.querySelector('div:nth-child(2)');if(note)note.textContent='Disaster-Recovery-ZIP mit GitHub-Code, App-Daten, Supabase-Datenbank und 48-Stunden-Sicherheitsnetz.';}
