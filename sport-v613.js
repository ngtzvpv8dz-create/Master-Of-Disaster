/* V613 · SPORT · cardio phases + editable sessions + compact planning */
(function(){
  'use strict';
  ...
  function rirStepper(value){
    ...
    return '<div class="sport-rir-stepper-v613" data-sport-rir-stepper>'+
  ...
  function workoutExerciseCard(exercise){
    ...
    return '<details class="sport-workout-card-v573 sport-workout-card-v613 status-'+esc(exercise.status)+'" data-sport-exercise-detail="'+esc(exercise.id)+'" '+(opened?'open':'')+'>'+
      '<summary class="sport-workout-summary-v613"><div><span>'+esc(itemTypeLabel(type))+' · '+esc(meta)+'</span><h3>'+esc(title)+'</h3>'+(settings?'<small class="sport-item-settings-v574">'+esc(settings)+'</small>':'')+'</div><b>'+esc(workoutStatusLabel(exercise.status))+'</b></summary>'+
      '<div class="sport-workout-body-v613">'+
        ...
        '<div class="sport-workout-actions-v573 sport-workout-actions-v613">'+
          '<button type="button" data-sport-move-exercise="'+esc(exercise.id)+'" data-direction="up" title="Nach oben">↑</button>'+
          '<button type="button" data-sport-move-exercise="'+esc(exercise.id)+'" data-direction="down" title="Nach unten">↓</button>'+
