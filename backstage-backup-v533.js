  ...
  function renderBackupDashboard(){
    ...
    view.innerHTML=`<section class="mod-backstage-backup-v533" data-backstage-backup-v533="true">
      ...
      <div class="mod-backstage-backup-grid-v533">
        ${backupCard({code:'B01',title:'VOLLBACKUP',text:'Disaster-Recovery-ZIP mit GitHub-Code, lokalem App-Stand, aktuellen Supabase-Nutzdaten und Datenbankstruktur, LIVE + PREVIOUS sowie dem rollierenden 48-Stunden-Sicherheitsnetz. Zugangsdaten werden nicht mitgesichert.',buttonLabel:'VOLLBACKUP ERSTELLEN',action:'fullbackup'})}
