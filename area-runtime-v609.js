...
(function(){
  ...
  const WARM_GROUPS={
    ...
    shopping:['./food-v544.js?v=643-shopping-bridge','./shopping-v646.js?v=646-polish'],
  ...
  async function verifyArea(id){
    if(id==='todo'){
      ...
      await waitFor(()=>window.__modShoppingV646||window.__modShoppingV645||window.__modShoppingV644||window.__modShoppingV643);
  ...
  async function openArea(id){
    ...
    if(id==='todo'){
      ...
      result=(window.__modShoppingV646||window.__modShoppingV645||window.__modShoppingV644||window.__modShoppingV643)?.open?.();
    }else if(id==='finance'){
