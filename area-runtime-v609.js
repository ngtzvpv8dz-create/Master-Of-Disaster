...
(function(){
  ...
  const GROUPS={
    ...
    shopping:[
      ...
      './supabase-client-lite-v593.js?v=593',
      './food-v544.js?v=643-shopping-bridge',
      './shopping-v649.js?v=649-feedback'
    ],
    kistology:[
      SUPABASE,
      './supabase-config.js?v=609',
  ...
  const WARM_GROUPS={
    ...
    shopping:['./food-v544.js?v=643-shopping-bridge','./shopping-v649.js?v=649-feedback'],
  ...
  async function verifyArea(id){
    if(id==='todo'){
      ...
      await waitFor(()=>window.__modShoppingV649||window.__modShoppingV648||window.__modShoppingV647||window.__modShoppingV646||window.__modShoppingV645||window.__modShoppingV644||window.__modShoppingV643);
  ...
  async function openArea(id){
    ...
    if(id==='todo'){
      ...
      result=(window.__modShoppingV649||window.__modShoppingV648||window.__modShoppingV647||window.__modShoppingV646||window.__modShoppingV645||window.__modShoppingV644||window.__modShoppingV643)?.open?.();
    }else if(id==='finance'){
